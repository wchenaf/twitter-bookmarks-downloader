...
func TestBuildFilename(t *testing.T) {
	...
	const tweetID = "1895276249498689869"
	const screenName = "nekoplanetOuO"
	...
	filename1 := buildFilename(screenName, tweetID, createdAtUTC, 0, 1, url1)
	...
	filename2 := buildFilename(screenName, tweetID, createdAtUTC, 0, 4, url1)
	...
	filename3 := buildFilename(screenName, tweetID, createdAtUTC, 3, 4, url1)
...
func TestBuildFilenameVideo(t *testing.T) {
	...
	filename := buildFilename("YamoakaMei", "1911758791701332134", createdAtUTC, 0, 1, urlVid)

...
func (_q *TweetQuery) QueryMedia() *MediaQuery {
...
func (_q *TweetQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *TweetQuery) FirstIDX(ctx context.Context) string {
...
func (_q *TweetQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *TweetQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *TweetQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *TweetQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TweetQuery) WithMedia(opts ...func(*MediaQuery)) *TweetQuery {
	query := (&MediaClient{config: _q.config}).Query()
...
func (_q *TweetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tweet, error) {
	...
	if query := _q.withMedia; query != nil {
		if err := _q.loadMedia(ctx, query, nodes,
			func(n *Tweet) { n.Edges.Media = []*Media{} },
			func(n *Tweet, e *Media) { n.Edges.Media = append(n.Edges.Media, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TweetQuery) loadMedia(ctx context.Context, query *MediaQuery, nodes []*Tweet, init func(*Tweet), assign func(*Tweet, *Media)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(media.FieldTweetID)
	}
	query.Where(predicate.Media(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tweet.MediaColumn), fks...))
	}))
